      ...
      <DialogContent className="max-w-2xl w-[95vw] max-h-[90vh] overflow-y-auto p-0 border-none rounded-none bg-background md:rounded-lg">
        ...
        >
          ...
          <section className="space-y-6">
            ...
            <div className="mb-8">
              <img 
                src={measurementIllustration} 
                alt="Measurement Guide Illustration" 
                className="w-full max-w-md mx-auto h-auto grayscale opacity-80"
              />
            </div>
          ...
          <section className="space-y-6">
            <h3 className="font-serif text-xl">Not sure about your size?</h3>
            <p className="text-sm text-muted-foreground leading-relaxed">
              We're here to help. Reach out for personalized assistance, including custom length and color options.
            </p>
            <div className="flex flex-wrap gap-4 pt-2">
              ...
              <a 
                href="mailto:gracemwaniki09@gmail.com"
                className="flex items-center gap-2 text-[10px] font-bold uppercase tracking-widest hover:text-primary transition-colors"
              >
